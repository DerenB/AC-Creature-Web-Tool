...
data_creature_south = [
    ...
    Creature(id=13, name="Lobster", price=4500, size="Large", speed="Quick", month_start=4, month_end=6, time_start=0, time_end=2359),
    Creature(id=14, name="Lobster", price=4500, size="Large", speed="Quick", month_start=12, month_end=1, time_start=0, time_end=2359),
    ...
    Creature(id=20, name="Pearl Oyster", price=2800, size="Small", speed="Moderate long lunges", month_start=1, month_end=12, time_start=0, time_end=2359),
